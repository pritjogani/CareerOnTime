...
try{
    const jobdata= await applyforjob.create({firstname,lastname,education,workexp,skills,achievement,expextedsalary,privioussalary,refrences,expirence,email,collagename});
